...
The Text-to-Speech (TTS) functionality in this application allows users to convert chat messages into high-quality spoken audio. It is powered by **Azure AI Speech Services** and supports a wide range of languages and voices.
...
- **Dynamic Voice Resolution**: Automatically selects the best voice based on the detected language of the message or user preferences.
...
- **Quick Overrides**: A context menu allows for temporary adjustments to voice and parameters for a single message.
