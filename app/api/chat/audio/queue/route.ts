 ...
 *
 * Check audio transcription queue position
 ...
 *
 * Add message to audio transcription queue
...
/**
 * PATCH /api/chat/audio/queue
 *
 * Update message in audio transcription queue
 * - messageId: string - unique identifier for the message
...
/**
 * DELETE /api/chat/audio/queue
 *
 * Delete message from audio transcription queue
 * - messageId: string - unique identifier for the message
 * - category: string / enum - category name (queue name)
 *
