...
describe('SpeedControl', () => {
  ...
  describe('Dropdown Toggle', () => {
    it('calls onToggleDropdown when button is clicked', () => {
      ...
      render(<SpeedControl {...defaultProps} onToggleDropdown={onToggleDropdown} />);
  ...
  describe('Speed Selection', () => {
    ...
    it('highlights current speed in dropdown', () => {
      render(<SpeedControl {...defaultProps} playbackSpeed={1.5} showDropdown={true} />);

      const speedOptions = screen.getAllByRole('button');
      const highlightedOption = speedOptions.find((option) =>
        option.textContent?.includes('1.5x') && option.classList.contains('font-semibold')
      );
    ...
    it('does not highlight non-selected speeds', () => {
      render(<SpeedControl {...defaultProps} playbackSpeed={1} showDropdown={true} />);
  ...
  describe('Styling', () => {
    ...
    it('dropdown has correct positioning classes', () => {
      const { container } = render(<SpeedControl {...defaultProps} showDropdown={true} />);
