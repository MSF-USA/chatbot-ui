...
import { AudioTimeDisplay, formatTime } from '@/components/Chat/Audio/AudioTimeDisplay';
...
describe('AudioTimeDisplay', () => {
  describe('Rendering', () => {
    it('renders time display', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={1} />);
    ...
    it('displays current time and duration with separator', () => {
      render(<AudioTimeDisplay currentTime={30} duration={120} playbackSpeed={1} />);
    ...
    it('shows formatted current time', () => {
      render(<AudioTimeDisplay currentTime={65} duration={200} playbackSpeed={1} />);

      expect(screen.getByText(/1:05/)).toBeInTheDocument();
    });

    it('shows formatted duration', () => {
      render(<AudioTimeDisplay currentTime={0} duration={185} playbackSpeed={1} />);
  ...
  describe('Playback Speed Display', () => {
    ...
    it('shows speed when playback speed is not 1', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={1.5} />);

      expect(screen.getByText('(1.5x)')).toBeInTheDocument();
    });

    it('shows speed for slower playback', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={0.75} />);

      expect(screen.getByText('(0.75x)')).toBeInTheDocument();
    });

    it('shows speed for faster playback', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={2} />);

      expect(screen.getByText('(2x)')).toBeInTheDocument();
    });

    it('displays speed in parentheses with x suffix', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={1.25} />);
  ...
  describe('Different Time Values', () => {
    it('handles zero duration', () => {
      render(<AudioTimeDisplay currentTime={0} duration={0} playbackSpeed={1} />);

      expect(screen.getByText(/0:00.*\/.*0:00/)).toBeInTheDocument();
    });

    it('handles matching current time and duration', () => {
      render(<AudioTimeDisplay currentTime={60} duration={60} playbackSpeed={1} />);

      expect(screen.getByText(/1:00.*\/.*1:00/)).toBeInTheDocument();
    });

    it('handles current time exceeding duration (edge case)', () => {
      render(<AudioTimeDisplay currentTime={100} duration={60} playbackSpeed={1} />);
    ...
    it('handles very short audio (under 1 minute)', () => {
      render(<AudioTimeDisplay currentTime={15} duration={30} playbackSpeed={1} />);

      expect(screen.getByText(/0:15.*\/.*0:30/)).toBeInTheDocument();
    });

    it('handles long audio (over 1 hour)', () => {
      render(<AudioTimeDisplay currentTime={1800} duration={3600} playbackSpeed={1} />);
    ...
    it('handles decimal time values', () => {
      render(<AudioTimeDisplay currentTime={65.8} duration={125.3} playbackSpeed={1} />);
  ...
  describe('Different Playback Speeds', () => {
    it('handles standard playback speeds', () => {
      ...
      speeds.forEach((speed) => {
        const { unmount } = render(
          <AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={speed} />
        );
    ...
    it('handles very slow playback speed', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={0.5} />);

      expect(screen.getByText('(0.5x)')).toBeInTheDocument();
    });

    it('handles very fast playback speed', () => {
      render(<AudioTimeDisplay currentTime={0} duration={100} playbackSpeed={3} />);
  ...
  describe('Edge Cases', () => {
    it('handles NaN values gracefully', () => {
      render(<AudioTimeDisplay currentTime={NaN} duration={100} playbackSpeed={1} />);
    ...
    it('handles negative time values', () => {
      render(<AudioTimeDisplay currentTime={-10} duration={100} playbackSpeed={1} />);

      expect(screen.getByText(/\//)).toBeInTheDocument();
    });

    it('handles Infinity duration', () => {
      render(<AudioTimeDisplay currentTime={0} duration={Infinity} playbackSpeed={1} />);
  ...
  describe('Real-world Scenarios', () => {
    it('displays initial state (not started)', () => {
      render(<AudioTimeDisplay currentTime={0} duration={180} playbackSpeed={1} />);

      expect(screen.getByText(/0:00.*\/.*3:00/)).toBeInTheDocument();
    });

    it('displays mid-playback state', () => {
      render(<AudioTimeDisplay currentTime={47} duration={180} playbackSpeed={1} />);

      expect(screen.getByText(/0:47.*\/.*3:00/)).toBeInTheDocument();
    });

    it('displays near-end state', () => {
      render(<AudioTimeDisplay currentTime={175} duration={180} playbackSpeed={1} />);

      expect(screen.getByText(/2:55.*\/.*3:00/)).toBeInTheDocument();
    });

    it('displays with fast playback', () => {
      render(<AudioTimeDisplay currentTime={30} duration={120} playbackSpeed={1.5} />);
    ...
    it('displays with slow playback', () => {
      render(<AudioTimeDisplay currentTime={30} duration={120} playbackSpeed={0.75} />);
