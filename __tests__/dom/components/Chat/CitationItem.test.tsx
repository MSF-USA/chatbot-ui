...
describe('CitationItem', () => {
  ...
  describe('Conditional Rendering', () => {
    it('returns null when title is missing', () => {
      ...
      const { container } = render(<CitationItem citation={citationWithoutTitle} />);
    ...
    it('returns null when url is missing', () => {
      ...
      const { container } = render(<CitationItem citation={citationWithoutUrl} />);
      expect(container.firstChild).toBeNull();
    });
    ...
    it('does not render date section when date is missing', () => {
      ...
      const { container } = render(<CitationItem citation={citationWithoutDate} />);
    ...
    it('does not render date section when date is empty string', () => {
      ...
      const { container } = render(<CitationItem citation={citationWithEmptyDate} />);
    ...
    it('does not render date section when date is whitespace', () => {
      ...
      const { container } = render(<CitationItem citation={citationWithWhitespaceDate} />);
