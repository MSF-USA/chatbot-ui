...
describe('PlaybackButton', () => {
  describe('Rendering', () => {
    ...
    it('renders play icon when not playing', () => {
      const { container } = render(<PlaybackButton isPlaying={false} onToggle={vi.fn()} />);
    ...
    it('renders pause icon when playing', () => {
      const { container } = render(<PlaybackButton isPlaying={true} onToggle={vi.fn()} />);
  ...
  describe('Accessibility', () => {
    ...
    it('updates aria-label when state changes', () => {
      const { rerender } = render(<PlaybackButton isPlaying={false} onToggle={vi.fn()} />);
  ...
  describe('State Changes', () => {
    ...
    it('changes icon when isPlaying changes to false', () => {
      const { rerender } = render(<PlaybackButton isPlaying={true} onToggle={vi.fn()} />);
  ...
  describe('Different onToggle Functions', () => {
    it('works with different callback functions', () => {
      ...
      const { rerender } = render(<PlaybackButton isPlaying={false} onToggle={callback1} />);
  ...
  describe('Edge Cases', () => {
    ...
    it('handles being clicked while state is changing', () => {
      const onToggle = vi.fn();
      const { rerender } = render(<PlaybackButton isPlaying={false} onToggle={onToggle} />);
