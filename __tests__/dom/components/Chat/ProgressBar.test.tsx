...
describe('ProgressBar', () => {
  describe('Rendering', () => {
    ...
    it('renders progress fill element', () => {
      const { container } = render(<ProgressBar progress={50} onSeek={vi.fn()} />);
    ...
    it('displays progress at 0%', () => {
      const { container } = render(<ProgressBar progress={0} onSeek={vi.fn()} />);
    ...
    it('displays progress at 100%', () => {
      const { container } = render(<ProgressBar progress={100} onSeek={vi.fn()} />);
  ...
  describe('Accessibility', () => {
    ...
    it('updates aria-valuenow when progress changes', () => {
      const { rerender } = render(<ProgressBar progress={25} onSeek={vi.fn()} />);
  ...
  describe('Click Behavior', () => {
    ...
    it('works with different onSeek functions', () => {
      const onSeek1 = vi.fn();
      const { rerender } = render(<ProgressBar progress={50} onSeek={onSeek1} />);
  ...
  describe('Different Progress Values', () => {
    ...
    it('handles progress at 25', () => {
      const { container } = render(<ProgressBar progress={25} onSeek={vi.fn()} />);
    ...
    it('handles progress at 75', () => {
      const { container } = render(<ProgressBar progress={75} onSeek={vi.fn()} />);
    ...
    it('handles decimal progress values', () => {
      const { container } = render(<ProgressBar progress={33.333} onSeek={vi.fn()} />);
    ...
    it('handles very small progress values', () => {
      const { container } = render(<ProgressBar progress={0.5} onSeek={vi.fn()} />);
    ...
    it('handles progress values over 100 (edge case)', () => {
      const { container } = render(<ProgressBar progress={150} onSeek={vi.fn()} />);
    ...
    it('handles negative progress values (edge case)', () => {
      const { container } = render(<ProgressBar progress={-10} onSeek={vi.fn()} />);
  ...
  describe('Progress Updates', () => {
    it('updates width when progress changes', () => {
      const { container, rerender } = render(<ProgressBar progress={0} onSeek={vi.fn()} />);
    ...
    it('updates aria-valuenow when progress changes', () => {
      const { rerender } = render(<ProgressBar progress={0} onSeek={vi.fn()} />);
  ...
  describe('Edge Cases', () => {
    it('handles NaN progress', () => {
      const { container } = render(<ProgressBar progress={NaN} onSeek={vi.fn()} />);
    ...
    it('handles Infinity progress', () => {
      const { container } = render(<ProgressBar progress={Infinity} onSeek={vi.fn()} />);
    ...
    it('clicking on progress fill also triggers onSeek', () => {
      const onSeek = vi.fn();
      const { container } = render(<ProgressBar progress={50} onSeek={onSeek} />);
  ...
  describe('Real-world Scenarios', () => {
    ...
    it('displays mid-playback state', () => {
      const { container } = render(<ProgressBar progress={47.5} onSeek={vi.fn()} />);
    ...
    it('displays near-end state', () => {
      const { container } = render(<ProgressBar progress={98.5} onSeek={vi.fn()} />);
