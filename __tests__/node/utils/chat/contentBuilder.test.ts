  ...
  describe('buildMessageContent', () => {
    describe('text submit type', () => {
      it('should return plain text for text-only message', () => {
        const result = buildMessageContent('text', 'Hello world', null, null);
      ...
      it('should handle empty text', () => {
        const result = buildMessageContent('text', '', null, null);
    ...
    describe('file submit type', () => {
      ...
      it('should handle multiple files as array', () => {
        const file2: FileMessageContent = {
          type: 'file_url',
          file_url: { url: 'https://example.com/report.docx' },
        };
      ...
      it('should omit text content if text is empty', () => {
        const result = buildMessageContent('file', '', null, fileContent);
      ...
      it('should filter out null files', () => {
        const file2: FileMessageContent = {
          type: 'file_url',
          file_url: { url: 'https://example.com/file2.pdf' },
        };

        const result = buildMessageContent('file', 'Check these', null, [
          fileContent,
          null,
          file2,
        ]);
    ...
    describe('edge cases', () => {
      it('should handle very long text', () => {
        ...
        const result = buildMessageContent('text', longText, null, null);
      ...
      it('should handle special characters in text', () => {
        ...
        const result = buildMessageContent('text', specialText, null, null);
      ...
      it('should handle unicode characters', () => {
        ...
        const result = buildMessageContent('text', unicodeText, null, null);
