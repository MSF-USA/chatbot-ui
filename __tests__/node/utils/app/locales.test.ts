...
import { localeToAutonym, getAutonym, getSupportedLocales } from '@/lib/utils/app/locales';

describe('locales', () => {
  describe('localeToAutonym', () => {
    it('contains all expected locales', () => {
      const expectedLocales = [
        'am', 'en', 'es', 'ar', 'bn', 'ca', 'cs', 'de', 'fa', 'fi',
        'fr', 'he', 'hi', 'id', 'it', 'ja', 'ko', 'my', 'nl', 'pl',
        'pt', 'ro', 'ru', 'si', 'sv', 'sw', 'te', 'th', 'tr', 'uk',
        'ur', 'vi', 'zh',
      ];
