...
describe('Hasher', () => {
  describe('sha256', () => {
    ...
    it('should return the correct SHA-256 hash for a string with special characters', () => {
      const inputString = '!@#$%^&*()_+';
      const expectedHash = '36d3e1bc65f8b67935ae60f542abef3e55c5bbbd547854966400cc4f022566cb';
    ...
    it('should return the correct SHA-256 hash for a string with Unicode characters', () => {
      ...
      const expectedHash = 'a3c6765090d5d618ab1283160b418a6b5bcec7b1852d05a3d51c2464613e44ac';
    ...
    it('should return the correct SHA-256 hash for a long string', () => {
      ...
      const expectedHash = '296975e61c987987e788ae8a653df681cd2e242956c5faf3ddc3bdb7c35506e2';
