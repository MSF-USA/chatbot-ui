...
const Home = ({
  ...
  useEffect(() => {
    ...
    if (systemPrompt) {
      ...
      dispatch({ field: 'systemPrompt', value: JSON.parse(customUserSystemPrompt) });
    } else if (process.env.NEXT_PUBLIC_DEFAULT_SYSTEM_PROMPT) {
      dispatch({ field: 'systemPrompt', value: JSON.parse(process.env.NEXT_PUBLIC_DEFAULT_SYSTEM_PROMPT)});
    } else {
      ...
      dispatch({ field: 'systemPrompt', value: JSON.parse(defaultSystemPrompt)});
    }
