...
export const PrivacyControlSection: React.FC<PrivacyControlSectionProps> = ({
  ...
  const filteredItems = privacyPolicyData.items.filter((item) => {
    const question =
      currentLocale === 'fr' && frenchTranslations[item.id]
