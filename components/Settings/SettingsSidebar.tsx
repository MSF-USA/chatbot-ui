  ...
  return (
      <div className="hidden md:block md:w-64 md:min-w-64 md:border-r border-gray-300 dark:border-neutral-700 p-4 overflow-y-auto flex flex-col h-full">
        ...
        <div className="space-y-2 mt-auto">
          ...
          <div
            className="flex items-center justify-between px-2 py-1 rounded-md hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors text-black/70 dark:text-white/70 text-sm"
          >
            ...
            <div
              className={`relative inline-block w-10 h-5 rounded-full cursor-pointer transition-colors ease-in-out duration-200 ${
                state.advancedMode ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'
              }`}
              onClick={() => dispatch({ field: 'advancedMode', value: !state.advancedMode })}
            >
              <span
