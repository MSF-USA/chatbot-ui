...
export const MobileAppSection: FC = () => {
  ...
  return (
    <div className="p-4">
      <h2 className="hidden md:flex text-xl font-bold mb-6 text-black dark:text-white items-center">
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center p-6 bg-gray-50 dark:bg-[#212121] rounded-lg border border-gray-200 dark:border-gray-700">
          ...
          <p className="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
            Scan this QR code with your mobile device to start the install
            process
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-[#212121] rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <div className="mb-3 p-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-md">
            <p className="text-xs text-amber-800 dark:text-amber-200 font-semibold">
              ⚠️ Important: You must use Safari browser. Other browsers like
              Chrome or Firefox will not work for installation on iOS.
            </p>
          </div>
          <ol className="space-y-2 text-sm text-gray-700 dark:text-gray-300 list-decimal list-inside">
            <li>
              <strong>Open this page in Safari</strong> (not Chrome or other
              browsers)
            </li>
            <li>
        ...
        <div className="space-y-2">
          <div className="text-xs text-gray-500 dark:text-gray-400 italic">
            Note: This installs the web app as a Progressive Web App (PWA) on
            your device. No app store required!
          </div>
          <a
