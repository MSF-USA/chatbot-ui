      ...
      <div className="space-y-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <li className="flex items-start">
              <IconCheck
                ...
                size={16}
              />
              <span>{t('Access the app directly from your home screen')}</span>
            </li>
            <li className="flex items-start">
              <IconCheck
                className="mr-2 mt-0.5 text-blue-600 dark:text-blue-400 shrink-0"
                size={16}
              />
              <span>{t('Works offline with cached conversations')}</span>
            </li>
            <li className="flex items-start">
              <IconCheck
                className="mr-2 mt-0.5 text-blue-600 dark:text-blue-400 shrink-0"
                size={16}
              />
              <span>{t('Faster loading and better performance')}</span>
            </li>
            <li className="flex items-start">
              <IconCheck
                className="mr-2 mt-0.5 text-blue-600 dark:text-blue-400 shrink-0"
                size={16}
              />
              <span>{t('Native app-like experience')}</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-white dark:bg-[#212121] rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <ol className="space-y-2 text-sm text-gray-700 dark:text-gray-300 list-decimal list-inside">
            <li>
              <strong>{t('Open this page in Safari')}</strong>{' '}
              {t('(not Chrome or other browsers)')}
            </li>
            <li>
              {t('Tap the')} <strong>{t('Share')}</strong>{' '}
              {t('button (square with arrow)')}
            </li>
            <li>
            ...
            <li>
              {t('Tap')} <strong>{t('Add')}</strong> {t('to confirm')}
            </li>
          </ol>
        </div>
        ...
        <div className="bg-white dark:bg-[#212121] rounded-lg p-4 border border-gray-200 dark:border-gray-700">
          ...
          <ol className="space-y-2 text-sm text-gray-700 dark:text-gray-300 list-decimal list-inside">
            ...
            <li>
              {t('Tap the')} <strong>{t('Menu')}</strong> {t('(three dots)')}
            </li>
            <li>
              {t('Tap')} <strong>{t('Install app')}</strong> {t('or')}{' '}
              <strong>{t('Add to Home screen')}</strong>
            </li>
            <li>
              {t('Tap')} <strong>{t('Install')}</strong> {t('to confirm')}
            </li>
          </ol>
        </div>
        ...
        <div className="space-y-2">
          ...
          >
            ...
            {t('Learn more about Progressive Web Apps')}
          </a>
        </div>
      </div>
    </div>
