                ...
                <div className="flex flex-wrap items-center w-full ml-4">
                    {files.map((file, index) => (
                        <div
                            ...
                            className="flex items-center justify-between p-3 m-1 rounded-lg border border-black dark:border-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                        >
                            <FileIcon className="w-8 h-8 mr-2" />
                            <span className="text-left flex-grow truncate">
                {file.originalFilename || file.url.split("/").pop()}
              </span>
                            <IconDownload className="opacity-50 group-hover:opacity-100" />
                        </div>
                    ))}
                </div>
            </div>
