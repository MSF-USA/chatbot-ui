  ...
  return (
    <div className="relative" onKeyDown={handleKeyDown}>
      ...
      {isOpen && (
        <div
          ref={dropdownRef}
          className="absolute left-0 bottom-full mb-2 transform -translate-x-full bg-white dark:bg-black border border-gray-200 dark:border-gray-700 rounded shadow-lg z-10 w-64"
          tabIndex={-1}
          role="menu"
        >
